...
<!-- navbar end -->
<a href="?profile=true" class="btn btn-outline-primary m-3 float-end">Back</a>
<?php
$fetch_complain = $con->query("SELECT * FROM `user` WHERE `id`='{$_GET['id']}'");
    ...
    <div class="col-12">
      <div class="card my-4">
        ...
        <div class="card-body px-0 pb-2">
          <form action="user/profile/uprofile.php" method="POST" enctype="multipart/form-data">
            <input type="hidden" name="id" class="form-control">
            <div class="row">
              <div class="col-md-6">
                <div class="input-group input-group-outline my-3">
                  <label class="form-label">Email</label>
                  <input type="text" name="designation" value="<?= $data['email'] ?>" class="form-control">
                </div>
              </div>
              <div class="col-md-6">
                <div class="input-group input-group-outline my-3">
                  <label class="form-label">Gender</label>
                  <!-- <input type="text" name="personalinformation" class="form-control"> -->
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="input-group input-group-outline my-3">
                  ...
                  <input type="text" value="<?= $data['uname'] ?>" name="uname" class="form-control">
                </div>
              </div>
              <div class="col-md-6">
                <div class="input-group input-group-outline my-3">
